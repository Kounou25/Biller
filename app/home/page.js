...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    setUserEmail(email); // Mettre à jour l'état avec l'email
  }, []);
  ...
  const styles = {
    container: {
      ...
      color: '#EAEAEA', // Couleur du texte clair
    ...
    header: {
      ...
      padding: '20px',
      textAlign: 'center',
      borderBottom: '2px solid #333', // Bordure inférieure pour séparation
    },
    title: {
      marginBottom: '5px',
      fontSize: '2em',
    ...
    card: {
      ...
      boxShadow: '0 2px 10px rgba(0, 0, 0, 0.5)', // Ombre pour profondeur
    },
    cardTitle: {
      marginBottom: '10px',
    },
